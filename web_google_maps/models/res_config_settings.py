...
class ResConfigSettings(models.TransientModel):
    ...
    def set_values(self):
        ...
        self.env['ir.config_parameter'].sudo().set_param('web_google_maps.google_maps_view_api_key',
                                                         self.google_maps_view_api_key)
        self.env['ir.config_parameter'].sudo().set_param('web_google_maps.google_maps_libraries',
                                                         self.google_maps_libraries)
        return res
    ...
    def get_values(self):
        ...
        privacy_pol = ICPSudo.get_param('web_google_maps.google_maps_view_api_key')
        privacy_pol2 = ICPSudo.get_param('web_google_maps.google_maps_libraries')
        res.update(
            google_maps_view_api_key=privacy_pol,
            google_maps_libraries=privacy_pol2
        )
        return res
