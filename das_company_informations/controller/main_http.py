...
class CompanyInfoHttp(http.Controller):

    @http.route(ProductInfo.version + 'legal-information-http', type='http', auth='public', methods=['Get'], cors="*")
    ...
    @http.route(ProductInfo.version + 'branches-http', type='http', auth='public', methods=['Get'], cors="*")
